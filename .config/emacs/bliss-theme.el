...
(autothemer-deftheme
 ...
 (
  ...
  (org-level-1 (:foreground purple :font "sans" :weight 'bold :height 1.5))
  (org-level-2 (:foreground blue :font "sans" :weight 'bold :height 1.4))
  (org-level-3 (:foreground green :font "sans" :weight 'bold :height 1.3))
  (org-level-4 (:foreground yellow :font "sans" :weight 'bold :height 1.2))
